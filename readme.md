# YOLOv11 Vehicle and Pedestrian Detection System

## Body

YOLOv11 Vehicle and Pedestrian Detection System Based on Deep Learning YOLOv11 (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 2
names: ['person', 'car'],
dataset quantity: training set 4485, validation set 1122.
